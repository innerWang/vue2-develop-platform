<template>
  ...
  >
    ...
    <template slot="footer">
      <a-button key="back" @click="handleCancel" :disable="editLoading">
        取消
      </a-button>
...
export default {
  ...
  computed: {
    ...mapState('org', ['isEditVisible', 'editLoading', 'currOrg']),
    ...mapGetters({
  ...
  methods: {
    handleCancel() {
      this.$store.commit('org/SET_FIELD', { field: 'isEditVisible', value: false });
